...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
		Group {
			AddFeedScreen(siteVM: SiteViewModel(siteInput: "https://mikespsyche.com"))
			AddFeedScreen(siteVM: SiteViewModel(siteInput: "https://macrumors.com"))
			AddFeedScreen(siteVM: SiteViewModel(siteInput: "https://mmo-champion.com"))
		}
    }
}
